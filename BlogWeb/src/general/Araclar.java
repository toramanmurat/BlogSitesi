...
public class Araclar {
	...
	public static TableModel tablaIcinModelOlustur(Object[] baslik,Object[][] veri) {
	...
	public static void mesajGoster(String mesaj,String mesajTipi) {
		if(mesajTipi.equals("HATA")) {
			...
			JOptionPane.showMessageDialog(new JFrame(), mesaj, "BİLGİ", JOptionPane.INFORMATION_MESSAGE);
		}
		else {
			
			JOptionPane.showMessageDialog(new JFrame(), mesaj, "UYARI", JOptionPane.WARNING_MESSAGE);
		}
	...
	public static int soruSor(String soruIcerik) {
		...
		int n=JOptionPane.showOptionDialog(new JFrame(), soruIcerik, "?"
